...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public android.graphics.Typeface createFromFontInfo(android.content.Context r21, @android.support.annotation.Nullable android.os.CancellationSignal r22, @android.support.annotation.NonNull android.support.v4.provider.FontsContractCompat.FontInfo[] r23, int r24) {
        ...
        L_0x0008:
            ...
            android.net.Uri r14 = r4.getUri()     // Catch:{ IOException -> 0x0039 }
            java.lang.String r15 = "r"
            r0 = r22
            android.os.ParcelFileDescriptor r9 = r10.openFileDescriptor(r14, r15, r0)     // Catch:{ IOException -> 0x0039 }
            r15 = 0
        ...
        L_0x0034:
            r16 = move-exception
            r15.addSuppressed(r16)     // Catch:{ IOException -> 0x0039 }
            goto L_0x0007
        L_0x0039:
            r5 = move-exception
            r14 = 0
            goto L_0x0007
        L_0x003c:
            r9.close()     // Catch:{ IOException -> 0x0039 }
            goto L_0x0007
        L_0x0040:
            android.graphics.Typeface$Builder r14 = new android.graphics.Typeface$Builder     // Catch:{ Throwable -> 0x0074, all -> 0x00f9 }
            java.io.FileDescriptor r16 = r9.getFileDescriptor()     // Catch:{ Throwable -> 0x0074, all -> 0x00f9 }
            r0 = r16
            r14.<init>(r0)     // Catch:{ Throwable -> 0x0074, all -> 0x00f9 }
            int r16 = r4.getWeight()     // Catch:{ Throwable -> 0x0074, all -> 0x00f9 }
            r0 = r16
            android.graphics.Typeface$Builder r14 = r14.setWeight(r0)     // Catch:{ Throwable -> 0x0074, all -> 0x00f9 }
            boolean r16 = r4.isItalic()     // Catch:{ Throwable -> 0x0074, all -> 0x00f9 }
            r0 = r16
            android.graphics.Typeface$Builder r14 = r14.setItalic(r0)     // Catch:{ Throwable -> 0x0074, all -> 0x00f9 }
            android.graphics.Typeface r14 = r14.build()     // Catch:{ Throwable -> 0x0074, all -> 0x00f9 }
            if (r9 == 0) goto L_0x0007
        ...
        L_0x0083:
            throw r14     // Catch:{ IOException -> 0x0039 }
        L_0x0084:
            r16 = move-exception
            r15.addSuppressed(r16)     // Catch:{ IOException -> 0x0039 }
            goto L_0x0083
